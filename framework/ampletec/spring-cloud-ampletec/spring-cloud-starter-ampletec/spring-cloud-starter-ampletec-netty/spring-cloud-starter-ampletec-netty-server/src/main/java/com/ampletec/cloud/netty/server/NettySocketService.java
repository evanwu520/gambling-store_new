...
import com.ampletec.cloud.netty.server.autoconfigure.NettyServerProperties;
import com.ampletec.cloud.netty.server.channel.TcpSocketServerInitializer;
import com.ampletec.cloud.netty.server.channel.WebSocketServerInitializer;
...
public class NettySocketService {
	...
	protected void startServer() throws Exception {
		...
		log.info("{} start successful!! port={}", this.properties.isWebsocket() ? "WebSocket": "Socket", properties.getPort());
	}
