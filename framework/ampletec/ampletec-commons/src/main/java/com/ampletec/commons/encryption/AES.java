...
public class AES {
	...
	public static void main(String[] args) throws Exception {
		String data = "1,2,3";
		String key = "d9c9873abdf7f133";
		String ret = AES.encrypt(data, key);
    ...
    public static String encryptWithKeyBase64(String data, String key) {
        try {
            byte[] valueByte = encrypt(data.getBytes(ConfigureEncryptAndDecrypt.CHAR_ENCODING), Base64.decodeBase64(key.getBytes()));
            return Base64.encodeBase64String(valueByte);
        } catch (UnsupportedEncodingException e) {
            throw new RuntimeException("encrypt fail!", e);
        }
    ...
    public static String genarateRandomKeyWithBase64() {
        return new String(Base64.encodeBase64String(genarateRandomKey()));
    }
